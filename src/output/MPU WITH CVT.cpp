...
void loop()
{
  ...
  switch(current_state)
  {
    ...
    case CVT_ST:
      CVTTempm = mlx.readObjectTempC();
     
      TKm = CVTTempm + 273;
            CVTTempr = (TKm * pow(0.95, -1/4)) - 273;

       Serial.print("*C\tObject = "); Serial.print(CVTTempm); Serial.println("*C");
